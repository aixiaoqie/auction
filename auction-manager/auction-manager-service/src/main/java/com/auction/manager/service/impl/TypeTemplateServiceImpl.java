...
import com.auction.manager.service.TypeTemplateService;
import com.auction.mapper.TbSpecificationOptionMapper;
import com.auction.mapper.TbTypeTemplateMapper;
import com.auction.pojo.TbSpecificationOption;
import com.auction.pojo.TbSpecificationOptionExample;
import com.auction.pojo.TbTypeTemplate;
import com.auction.pojo.TbTypeTemplateExample;
import com.auction.pojo.TbTypeTemplateExample.Criteria;
...
public class TypeTemplateServiceImpl implements TypeTemplateService {
	...
	public List<Map> findSpecOptionListByTypeId(Long typeId) {
		...
		for (Map map : specList) {
			...
			//创建criteria对象,设置查询参数
			com.auction.pojo.TbSpecificationOptionExample.Criteria createCriteria = example.createCriteria();
			//设置外键规格id查询规格选项
