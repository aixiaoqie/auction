...
import com.auction.manager.service.SpecificationService;
import com.auction.mapper.TbSpecificationMapper;
...
public class SpecificationServiceImpl implements SpecificationService {
	...
	public void update(Specification specification) {
		...
		// 创建criteria对象
		com.auction.pojo.TbSpecificationOptionExample.Criteria createCriteria = example
				.createCriteria();
		// 设置查询参数
