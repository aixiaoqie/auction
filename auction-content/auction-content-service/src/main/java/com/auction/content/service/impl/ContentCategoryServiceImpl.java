...
import com.auction.mapper.TbContentCategoryMapper;
import com.auction.pojo.TbContentCategory;
import com.auction.pojo.TbContentCategoryExample;
import com.auction.pojo.TbContentCategoryExample.Criteria;
...
public class ContentCategoryServiceImpl implements ContentCategoryService {
	...
	public void add(TbContentCategory contentCategory) {
		Date date = new Date();
		contentCategory.setCreatedTime(date);
		contentCategory.setUpdatedTime(contentCategory.getCreatedTime());
	...
	public void update(TbContentCategory contentCategory) {
		Date date = new Date();
		contentCategory.setUpdatedTime(date);
