...
import com.auction.manager.service.GoodsDescService;
...
public class GoodsDescController {
	 ...
	 */
	@RequestMapping("/add")
	public AuctionResult add(@RequestBody TbGoodsDesc goodsDesc){
		try {
	...
	public AuctionResult update(@RequestBody TbGoodsDesc goodsDesc){
		try {
