...
public class SpecificationOptionController {
	 ...
	 */
	@RequestMapping("/add")
	public AuctionResult add(@RequestBody TbSpecificationOption specificationOption){
		try {
	...
	public AuctionResult update(@RequestBody TbSpecificationOption specificationOption){
		try {
